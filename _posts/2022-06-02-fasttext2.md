---
layout: post
title: More on Fasttext for product embedding
excerpt: Fasttext as matrix factorization, and ideas for coldstart problem in recommendation

---

In the [previous](/_posts/2021-5-24-productembedding.md) post, I've introduce fasttext as a method for product embedding and discuss it advantages. Today, let's discuss some background and interesting corollaries of using fasttext in such way. 
