...
In the [previous](/_posts/productembedding.md) post, I've introduce fasttext as a method for product embedding and discuss it advantages. Today, let's discuss some background and interesting corollaries of using fasttext in such way. 
